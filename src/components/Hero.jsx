            ...
            <div className="hero_home_content">
              <div className={`home_hero_text ${isVisible ? 'visible' : ''}`}>
                <h1 className="hero_title">
                  ...
                  <span className="text-glow-red">Value-Driven Marketing.</span>
                </h1>
              </div>
              
              <p className={`hero_subtitle ${isVisible ? 'visible' : ''}`}>
                We transform businesses through strategic marketing solutions. 
                Build lasting customer relationships and drive sustainable growth with our expert team.
              </p>
